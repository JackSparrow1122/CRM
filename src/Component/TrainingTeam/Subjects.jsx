...
export default function SubjectManagement() {
  ...
  const fetchSubjects = async () => {
    ...
    setError(null);
    try {
      const res = await fetch("http://localhost:8081/getsubject");
  ...
  const handleUpdate = async () => {
    ...
    try {
      const res = await fetch(`http://localhost:8081/updateSubject/${editingId}`, {
        method: "PUT",
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`http://localhost:8081/deletesubject/${id}`, {
        method: "DELETE",
      });
  ...
  const handleAddSubject = async () => {
    ...
    try {
      const res = await fetch("http://localhost:8081/addSubject", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
