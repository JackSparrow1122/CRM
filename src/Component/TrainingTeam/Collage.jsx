...
export default function CollegeManagement() {
  ...
  const fetchColleges = async () => {
    ...
    setError(null);
    try {
      const res = await fetch("https://crm-backend-production-ad67.up.railway.app/getcolleges");
  ...
  const handleUpdate = async () => {
    ...
    try {
      const res = await fetch(`https://crm-backend-production-ad67.up.railway.app/updatecollege/${editingId}`, {
        method: "PUT",
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`https://crm-backend-production-ad67.up.railway.app/deleteCollege/${id}`, {
        method: "DELETE",
      });
