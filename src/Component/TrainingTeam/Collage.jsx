...
export default function CollegeManagement() {
  ...
  const fetchColleges = async () => {
    ...
    setError(null);
    try {
      const res = await fetch("http://localhost:8081/getcolleges");
  ...
  const handleUpdate = async () => {
    ...
    try {
      const res = await fetch(`http://localhost:8081/updatecollege/${editingId}`, {
        method: "PUT",
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`http://localhost:8081/deleteCollege/${id}`, {
        method: "DELETE",
      });
  ...
  const handleAddCollege = async () => {
    ...
    try {
      const res = await fetch("http://localhost:8081/addCollege", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
